...
export default function ContactSec({ popup }) {
  ...
  return (
    <section className={`px-5 py-3 w-full max-w-5xl rounded-lg place-self-center shadow-xl ${popup?"":" mt-5 border border-orange-400 bg-black bg-opacity-40"}`}>
     {!popup&& <h2 className="text-3xl mt-3px-5 text-red-600 font-bold text-center md:text-4xl md:text-left ">
        Contact me</h2>}
      <form className="flex flex-col w-full px-16 my-5"
      onSubmit={handleSubmit}>
        ...
        <input
          ...
          name="name"
          type="text"
          className={formState.nameValid ? "inputField outline-green-500" : "inputField outline-red-600"}
        ...
        <input
          ...
          name="email"
          type="email"
          className={formState.emailValid ? "inputField outline-green-500" : "inputField outline-red-600"}
          onBlur={fieldValidation}
          onChange={handleChange}
       ...
       {/* <label htmlFor="phone" className="formLabel">Phone:</label>
        ...
        <textarea
          ...
          placeholder="Message"
        />
        <button type="submit" className="py-6 px-6 mt-10 w-full place-self-end border border-gray-400 font-black text-lg sm:text-xl rounded-full shadow-lg bg-yellow-400 text-gray-900 transition duration-500 hover:bg-yellow-700 hover:text-gray-300 active:bg-yellow-900 focus:outline-none focus:ring focus:ring-orange-500">Submit</button>
      </form>
    </section>
  )
}
