...
export default function ProjectsCard({node}) {
  return (
    <div className="my-5 py-5 md:px-5  w-auto mx-auto" key={node.childMdx.id}>
          <a className="p-5 hover:bg-black flex h-full flex-col place-items-center w-72 transition duration-200 hover:bg-opacity-30 group border border-gray-700" href={node.childMdx.frontmatter.link}>
            <GatsbyImage
