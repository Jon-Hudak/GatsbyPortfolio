      ...
      <div className="border border-orange-400 rounded-lg shadow-xl bg-black bg-opacity-50 ">
        <div
          className={`flex flex-col-reverse lg:flex-row w-full grow  px-2 sm:px-24 sm:mt-6 max-w-5xl justify-between content-center rounded-md items-center ${
            contactOpen ? "pt-10 sm:pt-20" : "py-10 sm:py-20"
          }`}
        >
          <div className="px-10 max-w-lg">
            <motion.h1
              className="mt-5 text-5xl text-center lg:text-left  text-red-700 cursor-move"
              drag
              dragSnapToOrigin
            ...
            <motion.h2
              className="mt-5 text-2xl text-center lg:text-left cursor-move"
              drag
              dragSnapToOrigin
              dragTransition={{ bounceStiffness: 1, bounceDamping: 3 }}
              initial={{ opacity: 0, x: 50 }}
            ...
            <motion.button
              ...
              className={`relative py-6 px-6 mt-10 w-full font-black text-lg sm:text-xl rounded-full shadow-lg border border-gray-400  text-gray-900 transition hover:bg-yellow-700 hover:text-gray-300 active:bg-yellow-900 focus:outline-none focus:ring focus:ring-orange-500 ${
